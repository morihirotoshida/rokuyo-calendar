            ...
            document.querySelectorAll('.fc-daygrid-day').forEach(dayEl => {
                ...
                if (rokuyoEvent) {
                    ...
                    if (frameEl) {
                        ...
                        // extendedPropsから旧暦の日付を取得
                        const lunarDay = rokuyoEvent.extendedProps.lunar_day; 
                        
                        // 旧暦の日付と六曜を表示
                        bottomEl.innerHTML = `<span>${lunarDay}</span><span class="rokuyo-text">${rokuyoEvent.title}</span>`;
